...
def create_parameters(parametersA: list, jsonData: list) -> None:
        ...
        properties = filezC[4]
        prop0 = str(properties[0])
        prop1 = str(properties[1])
        prop2 = str(properties[2])
        prop3 = str(properties[3]) 
        ...
        # Cards[0] = prop2['type']
        # Cards[1] = prop2['name']
        # Elements[0] = prop3['type']
        # Elements[1] = prop3['name']
        ...
        finalDataList = [file_path, nft_name, external_link, description, collection, ["BG", prop0, "Plate", prop1, "Cards", prop2, "Element", prop3], unlockable_content, explicit_and_sensitive_content, supply, blockchain, type, price, duration, specific_buyer, quantity]
...
class Opensea(object):
                    ...
                    for li in range(ul):
                        ...
                        if self.element_visible(
                            ...
                            '/button/div[2]/span[1]').text \
                                == "Polygon":
                            # Click on specific Blockchain button. (Polygon)
    ...
    def sell_nft(self) -> None:
        ...
        try:
            ...
            self.element_send_keys(
                    '//input[@name="price"]', str(paramsList[13]))
            # Click on "Create" button.
